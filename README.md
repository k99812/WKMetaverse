## WKDCMetaverseS2
해당 저장소는 WKDCMetaverseS2의 원본 저장소가 private라 제가 주도적으로 작성한 스크립트를 모아놓았습니다.

Unity와 Photon을 사용하여 멀티플레이 메타버스 환경을 구현한 팀 프로젝트입니다.   
캐릭터 선택, 채팅 시스템, 방 입장 및 이동 로직 등을 클라이언트 측에서 구현하였고,   
멀티플레이 개발의 기초를 학습하였습니다.
